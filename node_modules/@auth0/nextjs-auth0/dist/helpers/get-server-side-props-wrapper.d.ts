 ...
 * @category Server
 */
export declare type GetServerSidePropsWrapper = (getServerSideProps: GetServerSideProps) => GetServerSideProps;
/**
 * @ignore
 */
export default function getServerSidePropsWrapperFactory(getSessionCache: () => SessionCache): (getServerSideProps: GetServerSideProps) => GetServerSideProps;
//# sourceMappingURL=get-server-side-props-wrapper.d.ts.map