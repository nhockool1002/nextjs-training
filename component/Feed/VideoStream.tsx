     ...
     <div>
        <div className="container">
          <div className="col-12 text-center mt-2">
            <Button type="primary" danger onClick={stopStreaming} style={{ marginRight: "10px" }} disabled={disabledStop}>STOP STREAM</Button>
            <Button type="primary" onClick={startStreaming} disabled={disabledStart}>START STREAM</Button>
          </div>
        </div>
     </div>
    </>
